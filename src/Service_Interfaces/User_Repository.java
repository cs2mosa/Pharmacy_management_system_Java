...
/**
 * UserRepository is an interface that defines the contract for managing User
 * entities.
 * It provides methods to add, update, delete, and retrieve users by their
 * username or ID.
 */
interface UserRepository {
     ...
     * @return The unique identifier of the newly added user. -1 if the user already
     *         exists.
     * @throws IllegalArgumentException if the user is null or has invalid
     *                                  properties.
     */
     ...
     * @return The unique identifier of the updated user. -1 if the user does not
     *         exist.
     * @throws IllegalArgumentException if the user is null or has invalid
     *                                  properties.
     */
     ...
     * @return 0 if the user was successfully deleted, -1 if the user does not
     *         exist.
     * @throws IllegalArgumentException if the user is null or has invalid
     *                                  properties.
     */
     ...
     * @return The User object corresponding to the given username, or null if not
     *         found.
